...
public class WeatherController extends AppCompatActivity {
    ...
    final String APP_ID = "8d7c4559c7539ee68d49f3abf0046313";
    ...
    LocationListener mLocationListener = new LocationListener() {
        ...
        public void onLocationChanged(Location location) {
            ...
            Log.d("Climate","Longitude set to:" + longitude);
            Log.d("Climate","Latitude set to:" + latitude);
        ...
        public void onProviderDisabled(String provider) {
            Log.d("Climate", "onProviderDisabled() called");
        }
    };
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if(requestCode == REQUEST_CODE){
            if(grantResults.length>0 && grantResults[0]== PackageManager.PERMISSION_GRANTED){
                Log.d("Climate", "onRequestPermissionGranted(): Permission Granted!!");
                getWeatherForCurrentLocation();
            }
            else {
    ...
    private void letsDoSomeNetworking(RequestParams params){
        ...
        client.get(WEATHER_URL,params, new JsonHttpResponseHandler(){
            ...
            public  void onSuccess(int statusCode, Header[] headers , JSONObject response){
                ...
                Log.d("Climate","Success! Json:"+response.toString());
